...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          ?>
            <div class="table-responsive">
              ...
              <tbody>
              <?php
                $shift1 = $koneksi->query("SELECT s.id_sensor, s.lokasi, count(*) as jumlah FROM produksi p INNER JOIN sensor s ON p.id_sensor = s.id_sensor WHERE TIME(waktu)>='15:00:01' and TIME(waktu)<='23:00:00' AND DATE(waktu)='$today'");
                // $data1 = $shift1->fetch_row();
                // echo $data1[0];
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="http://adminlte.io">POLINEMA</a>.</strong>
    <!-- All rights reserved. -->
