            ...
            <?php
                ...
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        // echo "</td>";
                        echo "<td>";
						echo "<a class='btn btn-warning mr-2' href='updateUserF.php?id=".$row["id"]."'>Update</a>";
						echo "<a class='btn btn-danger' href='controller/deleteUser.php?id=".$row["id"]."'>Hapus</a>";
						echo "</td>";
                    }
                }
            ?>
