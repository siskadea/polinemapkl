            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    ?>
                                ...
                                <a href="mesin.php" class="small-box-footer">Detail <i
                    ...
                    ?>
                                ...
                                <a href="index1.php" class="small-box-footer">Detail <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                      ...
                      ?>
                                ...
                                <a href="bulanNew.php" class="small-box-footer">Detail <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                      ...
                      ?>
                                ...
                                <a href="tahunNew.php" class="small-box-footer">Detail <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
