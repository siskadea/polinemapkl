...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <i class="nav-icon fas fa-book"></i>
                <p>
                  Laporan
                  <!-- <i class="right fas fa-ange-left"></i> -->
                </p>
              </a>
            </li>
            <li class="nav-item has-treeview">
    ...
    <div class="content-wrapper">
      ...
      <form action="controller/tambahSensor.php" method="POST">
                <!-- <div class="form-group">
                    <label>ID SENSOR</label>
                    <input type="text" class="form-control" name="id_sensor"  require>
                </div> -->
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>LOKASI</label>
                    <input type="text" class="form-control" name="lokasi"  require>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-success" name="tambah" value="Tambah">
                    <a class="btn btn-danger" href="mesin.php">Batal</a>
                </div>
            </form>
      </section>
      <!-- /.content -->
