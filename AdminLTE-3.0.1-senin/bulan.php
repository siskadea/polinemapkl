          ...
          <div class="row mb-2">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                  <?php
                  $bulanan = $koneksi->query("SELECT s.keterangan, s.lokasi, count(*) as jumlah FROM produksi p INNER JOIN sensor s ON p.id_sensor = s.id_sensor WHERE MONTH(waktu) = MONTH(CURRENT_DATE())");
